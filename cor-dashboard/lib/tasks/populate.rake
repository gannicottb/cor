namespace :db do
  ...
  task :populate => :environment do
    ...
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 114, :reading_time => Time.now + 3.day)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 115, :reading_time => Time.now + 2.day)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 114, :reading_time => Time.now + 1.day)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 115, :reading_time => Time.now)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 116, :reading_time => Time.now - 1.day)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 117, :reading_time => Time.now - 2.days)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 118, :reading_time => Time.now - 3.days)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 115, :reading_time => Time.now - 4.days)
    ...
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 140, :reading_time => Time.now - 7.days)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 145, :reading_time => Time.now - 8.days)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 144, :reading_time => Time.now - 9.days)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 145, :reading_time => Time.now - 10.days)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 146, :reading_time => Time.now - 11.days)
    ...
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 144, :reading_time => Time.now - 14.days)
    WeightReading.create(:patient_id => patient.id, :bo_sensor_id => 123456789, :weight => 146, :reading_time => Time.now - 15.days)
